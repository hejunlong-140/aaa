	...
	<form class="layui-form" action="{{url('brand/update/'.$brand->brand_id)}}" method="post" enctype="multipart/form-data">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      ...
	      placeholder="请输入品牌名称" class="layui-input" value="{{$brand->brand_name}}">
	    </div>
	  </div>
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      ...
	      placeholder="请输入品牌Url" class="layui-input" value="{{$brand->brand_url}}">
	    </div>
	  </div>
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      ...
	      placeholder="请输入品牌简介" class="layui-input">{{$brand->brand_desc}}</textarea>
	    </div>
	  </div>
